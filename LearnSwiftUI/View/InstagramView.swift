...
struct InstagramView: View {
    @ObservedObject var countMessageGlobal = GLobalObject()
    init() {
        customNavBar()
    }
    ...
    var body: some View {
        NavigationView{
            StoryView(countMessageGlobal: countMessageGlobal)
                .padding(3)
                .navigationBarItems(
                    leading: HStack{
                    ...
                    trailing: HStack{
                        ...
                        ZStack{
                            Button(action: {print("messsage click")}, label: {
                                NavigationLink(destination : MessageView(countMessageGlobal: countMessageGlobal)){
                            ...
                            Text("\(countMessageGlobal.messageCount)")
    ...
    var body: some View{
        VStack(){
            ScrollView(.vertical, showsIndicators: false){
                ...
                ContentInstagramView(countMessageGlobal : countMessageGlobal)
            }
        }
...
struct ContentInstagramView : View {
    ...
    let dataContent : [InstagramContent] = [
        ...
        InstagramContent(id: 3, imageUser: "img_rasyid", nameUser: "Marcelo", imageContent: "img_bicycle", likedBy: "Dani Carvajal", likedOther: "100.000", favoriteContent: true),
        InstagramContent(id: 4, imageUser: "img_rasyid", nameUser: "Ronaldo", imageContent: "swift", likedBy: "Dani Carvajal", likedOther: "80.000", favoriteContent: false),
    ...
    var body: some View{
        ForEach(dataContent){
            ...
            HStack{
                ...
                Button(action: {print("send click : \(self.countMessageGlobal.messageCount += 1) \(countMessageGlobal.messageCount)")}, label: {
...
struct MessageView : View {
    ...
    var body: some View{
        VStack{
            ScrollView(.vertical){
                ForEach(0..<countMessageGlobal.messageCount){
                    data in
